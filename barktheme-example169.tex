...
% Version: 0.1.3,  22/09/2019

\documentclass[aspectratio=169]{beamer}
%\documentclass[handout]{beamer} %to neglect the effect of \pause commands
...
\begin{document}
	...
	\begin{frame}{Example for wrapfigure without caption}
		...
		\begin{wrapfigure}{r}{0.2\textwidth} % Its use is a littlebit problematic but not impossible...
			\vspace{-20pt}
			\begin{center}
	...
	\begin{frame}{Example for subfigures}
		\begin{figure}[ht]
			...
			\subfigure[Subfigure 1 caption]{
				\includegraphics[width = 0.4\textwidth] {img/example_fig_1}
				\label{fig:subfig1}
			} \\
			...
			\subfigure[Subfigure 3 caption]{
				\includegraphics[width = 0.1\textwidth] {img/example_fig_2}
				\label{fig:subfig3}
			}
			\label{myfigure}
	...
	\begin{frame}{Creating a handout}
		...
		The "$\backslash$threeframeslayout" command is not supported yet.
	...
	\begin{frame}{Example for animation}
		...
		\animategraphics[controls,width=0.4\textwidth]{5}{img/UR5animation/UR5_pinv--}{1}{36}
	...
	\begin{frame}{Animation compatible with the threeframeslayout}
		...
		\animategraphics[controls,center,width=0.34\textwidth]{5}{img/UR5animation/UR5_pinv--}{1}{36}
	\end{frame}
...
\end{frame}
	...
	\thankyouforattentionframe{\footnotesize The research was supported by my free time. This very very very very long text is only to check the size of this textbox...\\ By the way, the theme is based on the Warsaw beamer theme of Till Tantau.\\ Best regards, J. Kuti  }
